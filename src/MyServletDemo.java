...
public class MyServletDemo extends HttpServlet {
	...
	/*Ги враќа трите најкратки растојанија од внесените координати
	* до 3те најблиски ресторани и растојанијата (во метри) ги
	* запишува во txt фајл
	*/
...
/*Креирање html фајл кој се прикажува при повик на Servlet - кликање на копче Search
 * ги прикажува растојанијата до најблиските ресторани
 */
class CreateHtml {
	public void createHtml() throws IOException {
		File f = new File("distance.html"); // ne smeam do disk
																									// lokalno!!!!!
		...
		while (line != null) {
			bw.write("<p style=\"font-size:3vw; margin-left:10px\">" + line
					+ "</p><div style=\"margin-top: -95px; margin-left:475px\"><img onclick=\"addToVisited()\" style=\"height:16%; width:20%; cursor:pointer\" src=\"slikiApp/pin_shadow.png\"><img onclick=\"addToFaves()\" style=\"height:16%; width:28%; cursor:pointer\" src=\"slikiApp/favourites.png\"></div>");
			bw.write("<br>");
			line = br.readLine();
		}
		br.close();
